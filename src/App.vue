<template>
  <div id="app">
   ...
   rel="stylesheet">
    ...
    <h1 class="h1-style mt-5"
      >Hello!<br />Which one are you?</H1
    >
    ...
    <!-- Designer -->
    <div v-if="role == 0">
      <H1 class="h1-style mt-5">Designer</H1><BR />
      ...
      <div class="container">
        <div class="container container-white">
          ...
          <div class="row">
            <div class="col-sm-9" style="border-right: 2px solid #ffd3d3">
            ...
            <div class="col-sm-3" style="border-right: 2px solid #ffd3d3">
        ...
        <div class="row">
            ...
            >
             <hr class="hr1">
              <button class="button blue mb-3 float-right" @click="updateBalance()">
                Update
              </button>
            </div>
        </div>
      ...
      <!-- Incoming Order -->
      <div class="container">
        <div class="container container-white pb-5">
          <div class="row" style="background-color: #4961cb">
            <aside class="aside-style">
              Incoming order
            </aside></div>
          <div v-if="paymentDone">
            <h3 class="mt-3">Order #1</h3>
            <BR />
                <p style="margin-bottom: -5%">A customer has made a pending payment of {{ sellPrice }} for
                Item A</p>
    ...
    <div v-else-if="role == 1">
      <BR /><BR />
         <H1 class="h1-style mt-5">Customer</H1>
      ...
      <div class="mt-5">
        ...
        <button class="button1 ml-4" @click="attachContract1()">Attach</button>
      </div>
      ...
      >
        ...
        <div v-if="paymentDone">
          ...
          <BR /><BR />
          <div v-if="pickupDone">
            <h3 class="mb-2">Order received?</h3>
            <button @click="yesnoDelivery(true)" class="button1 mr-3">YES</button>
            <button @click="yesnoDelivery(false)" class="button2">NO</button>
          </div>
        </div>
        <h5 class="mt-5">Track the progress of your item(s).</h5>
    ...
    <div v-else-if="role == 2">
      ...
      <BR /> <BR />
      <input v-model="ctcStr" placeholder="paste contract here" />
      <button class="button1 ml-4" @click="attachContract2()">Attach</button>
        ...
        <div class="container container-white">
          ...
          <div v-if="paymentDone">
            ...
            <BR />
                ...
                {{ transPrice }}. <br /> 
                Do you accept this order? <br />
                <button @click="yesnoTransport(true)" class="button1 mt-3 mr-3">
                  Yes
                </button> 
...
export default {
  ...
  methods: {
    ...
    reportOrderReceived() {
      ...
      this.deliveryMsg = `Customer had received product in well condition. All payments are transferred to designer and transporter.`;
    ...
    reportAcceptDelivery() {
      ...
      this.pickupMsg = `The transporter have accepted the delivery.The customer have made payment of 1.3 to the contract.`;
      this.deliveringMsg = `Your product has been delivered.`;
